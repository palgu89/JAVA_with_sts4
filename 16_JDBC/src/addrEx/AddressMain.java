		...
		while (flag) {
			...
			case 3:
				...
				case 1:
					System.out.println("이름 > ");
					name = sc.next();
					Address addr = service.getDetail(name);
					System.out.println(addr);	// addr에 toString 해놨으니 toString이 출력 될 것
					break;
				case 2:
					System.out.println("전화번호 > ");
					tel = sc.next();
					Address addr2 = service.getDetailByTel(tel);
					System.out.println(addr2);
					break;
				case 3:
					System.out.println("나이 > ");
					age = sc.nextInt();
					List<Address> list2 = service.getListByAge(age);
